...
describe('Replace in file', () => {
  ...
  describe('Async with promises', () => {
    ...
    it('should return changed files for replacements that result in an identical file', done => {
      replace({
        files: 'test1',
        from: 'place',
        to: 'place',
  ...
  describe('Sync', () => {
    ...
    it('should return changed files for replacements that result in an identical file', function() {
      const changedFiles = replace.sync({
        files: 'test1',
        from: 'place',
        to: 'place',
